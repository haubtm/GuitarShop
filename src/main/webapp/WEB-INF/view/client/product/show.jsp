    ...
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            <%@ taglib prefix="form" uri="http://www.springframework.org/tags/form" %>
                ...
                <head>
                    <meta charset="utf-8">
                    <title> Sản Phẩm - Guitarshop</title>
                                            ...
                                            <div class="col-12" id="factoryFilter">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-1"
                                                        value="Kawai">
                                                    <label class="form-check-label" for="factory-1">Kawai</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-2"
                                                        value="Yamaha">
                                                    <label class="form-check-label" for="factory-2">Yamaha</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-3"
                                                        value="Taylor">
                                                    <label class="form-check-label" for="factory-3">Taylor</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-4"
                                                        value="Martin">
                                                    <label class="form-check-label" for="factory-4">Martin</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-5"
                                                        value="Suzuki">
                                                    <label class="form-check-label" for="factory-5">Suzuki</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-6"
                                                        value="Pearl">
                                                    <label class="form-check-label" for="factory-6">Pearl</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="factory-7"
                                                        value="Tanglewood">
                                                    <label class="form-check-label" for="factory-7">Tanglewood</label>
                                                </div>
                                            </div>
                                            <div class="col-12" id="targetFilter">
                                                <div class="mb-2"><b>Loại nhạc cụ</b></div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-1"
                                                        value="Guitar">
                                                    <label class="form-check-label" for="target-1">Guitar</label>
                                                </div>

                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-2"
                                                        value="Piano">
                                                    <label class="form-check-label" for="target-2">Piano</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-3"
                                                        value="Drum">
                                                    <label class="form-check-label" for="target-3">Drum</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-4"
                                                        value="Violin">
                                                    <label class="form-check-label" for="target-4">Violin</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="checkbox" id="target-5"
                                                        value="Organ">
                                                    <label class="form-check-label" for="target-5">Organ</label>
                                                </div>
